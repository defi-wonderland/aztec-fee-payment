...
| 1.5.2   | 2026-07-01 | Updated Target Aztec Version from `5.0.0-rc.1` to `5.0.0-rc.2` to match package dependencies (all `@aztec/*` packages and the `aztec-nr` Noir dependencies). The `@defi-wonderland/aztec-benchmark` dev-dependency now points at the `5.0.0-rc.2` prerelease tarball. No code or spec changes — version bump only; Noir contracts recompile, all Noir unit tests and TS unit tests (gas) pass.                                                                                                                                                                                                                                                          |
