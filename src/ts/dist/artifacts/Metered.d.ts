...
export declare class MeteredContract extends ContractBase {
     ...
     */
    static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet): DeployMethod<MeteredContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified constructor method.
     */
    static deployWithOpts<M extends keyof MeteredContract['methods']>(opts: {
        publicKeys?: PublicKeys;
        method?: M;
        wallet: Wallet;
    }, ...args: Parameters<MeteredContract['methods'][M]>): DeployMethod<MeteredContract>;
    /**
    ...
    methods: {
        ...
        mint: ((account: AztecAddressLike, amount: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** pay_fee() */
        pay_fee: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** pay_fee_exact() */
        pay_fee_exact: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
