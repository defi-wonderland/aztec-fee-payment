 ...
 */
export declare function recoverClaimRequestSigner(message: ClaimRequestMessage, signature: Hex, chainId: number): Promise<Address>;
/**
 * Returns the typed data object for client-side signing.
 */
export declare function getTypedDataForSigning(txHash: Hex, chainId: number): {
    domain: {
        chainId: number;
