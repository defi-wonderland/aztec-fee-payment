...
/**
 * Usage:
 *   AZTEC_ARTIFACT_REGISTRY_URL=https://devnet.aztec-registry.xyz/ tsx scripts/upload-artifact.ts target/bridged_contract-BridgedFPC.json
 *
 * Notes:
...
async function main() {
  const artifactPathArg =
    process.argv[2] ?? "target/bridged_contract-BridgedFPC.json";
